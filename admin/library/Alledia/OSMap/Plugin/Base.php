...
abstract class Base extends CMSPlugin
{
    ...
    /**
     * Минимальный объем памяти в МБ, необходимый для продолжения на сайтах с ограниченным объемом памяти
     *
    ...
    /**
     * Установите лимит памяти на неограниченный. Если не в состоянии сделать это,
     * мы хотим проверить, достаточно ли у нас осталось памяти для продолжения,
     * так что мы можем изящно потерпеть неудачу
     *
