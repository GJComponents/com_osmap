...
//	            echo'<pre>';print_r( $node->fullLink );echo'</pre>'.__FILE__.' '.__LINE__;
     ...
     * @param Item      $parent - Объект пункта меню Alledia\OSMap\Sitemap\Item
...
//	    }#END IF
	    ...
	    switch ($view) {
            ...
            case 'article':
                /**
                 * если это пункт меню статьи, мы должны проверить, нужно ли расширять
                 * разрыв страницы статьи
                 *
